...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/holographic_video_decoder/";
            },},{id: "projects-lens-simulation",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/mesh_editor/";
            },},{id: "projects-pathtracer",
          title: 'Pathtracer',
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-vellum-dress",
          title: 'Vellum Dress',
          description: "Dress made and simulated in Houdini using Vellum tools.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/vellum_dress/";
