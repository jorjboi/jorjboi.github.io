...
To keep the top more static for the rest of the drape set up, I use `Pin to Animation` to keep it static.
...
By using a distance constraint and lowering the `rest length scale` for the primitives along the edges of the frill, I'm able to create a smoother transition.
